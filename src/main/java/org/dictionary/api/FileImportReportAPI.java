...
public class FileImportReportAPI {
	...
	public String toString() {
		return "FileImportReportAPI [success=" + success + ", filename=" + filename + ", numWordsCreated=" + numWordsCreated + ", numTranslationsCreated=" + numTranslationsCreated + ", message=" + message + "]";
	}
